...
#show: mantys(
  ...
  license: "MIT",
  description: "A library for producing syntax tree graphs.",
  repository: "https://github.com/pearcebasmanm/syntree",

  title: "Syntree",
  subtitle: "A library for producing syntax tree graphs.",
  date: datetime.today(),

  examples-scope: (
    scope: (syntree: syntree),
    // imports: (syntree: "tree")
  ),
  show-index: false,
  theme: themes.modern,
  ..toml("../typst.toml"),
...
#syntree.tree(tree, label-alignment: "smart")
```)
...
#scale(11%, reflow: true, syntree.tree(tree, label-alignment: "average", min-space-y: 2))
```)
